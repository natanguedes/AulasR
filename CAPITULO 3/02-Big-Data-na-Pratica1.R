...
# Usando read.csv2()
system.time(df_teste1 <- read.csv2("E://Natanael//tsi//3periodo//estatisticazdatascienceacademy-Curso-R\\datascienceacademy-Curso-R\\CAPITULO 3\\TemperaturasGlobais/TemperaturasGlobais.csv"))
