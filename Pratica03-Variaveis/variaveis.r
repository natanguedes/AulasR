...
meses = c("janeiro","fervereiro","março","ABRIL","MAIO","JUNHO","JULHO","AGOSTO","SETEMBRO","OUTUBRO","NOVEMBRO","DEZEMBRO")
meses


#nominal

animaIS = c("cavalo","cachorro","bezerro")
animaIS
...
#variável idade é continua , de 0 a 6 anos etc...
#peso = variavel quantitativa contínua ex: 12,6g ; 10,8g etc
