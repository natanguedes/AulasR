...
# Usando read.csv2()
f_teste1 <- read.csv2("E:/datascienceacademycodecourse/EstatisticaR/Pratica02/TemperaturasGlobais.csv")

df_teste1 <- read.csv2("E:/datascienceacademycodecourse/EstatisticaR/Pratica02/TemperaturasGlobais.csv")
df_teste1
# Usando read.table()
system.time(df_teste2 <- read.table(""))


# Usando fread()
?fread
df <- fread("TemperaturasGlobais/TemperaturasGlobais.csv")
read=read.csv2("E:/datascienceacademycodecourse/EstatisticaR/Pratica02/TemperaturasGlobais.csv" , sep="," , dec=".")
read
